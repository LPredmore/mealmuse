        ...
        <div className="space-y-8 print:space-y-6">
          ...
          {meal.equipment_needed && meal.equipment_needed.length > 0 && (
            <div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 print:bg-gray-50 print:border-gray-200">
                <div className="flex flex-wrap gap-2">
                  {meal.equipment_needed.map((equipment, index) => (
                    <Badge key={index} className="bg-cyan-500/20 text-cyan-300 border-cyan-500/30 border backdrop-blur-sm print:bg-gray-100 print:text-gray-800 print:border-gray-300">
                      {equipment}
                    </Badge>
                  ))}
                </div>
